...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "sound.enabled": "Play fireplace ambience",
        "sound.volume": "Volume",
        "sound.hint": "Soft brown roar and crackles — louder and livelier as the fire grows. Mutes when the flame is hidden.",
    ...
    private static let zh: [String: String] = [
        ...
        "sound.title": "壁炉音效",
        "sound.enabled": "播放火焰环境音",
        "sound.volume": "音量",
        "sound.hint": "柔和的低沉轰鸣与噼啪声——火势越大越响、越热闹。隐藏火焰时自动静音。",
        "menu.hideFlame": "隐藏火焰",
        "menu.showFlame": "显示火焰",
    ...
    private static let ja: [String: String] = [
        ...
        "sound.title": "暖炉の音",
        "sound.enabled": "炎の環境音を再生",
        "sound.volume": "音量",
        "sound.hint": "柔らかな低音の轟きとパチパチ音。火勢が強いほど大きく、生き生きします。炎を隠すとミュート。",
        "menu.hideFlame": "炎を隠す",
        "menu.showFlame": "炎を表示",
    ...
    private static let ko: [String: String] = [
        ...
        "sound.title": "벽난로 소리",
        "sound.enabled": "불꽃 환경음 재생",
        "sound.volume": "음량",
        "sound.hint": "부드러운 저음 울림과 타닥 소리 — 불길이 셀수록 더 크고 살아납니다. 불꽃을 숨기면 음소거됩니다.",
